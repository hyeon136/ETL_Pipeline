...
def extract():
    ...
    """
    import ETL_Pipeline.modules.requests_ as request

    url = "http://ec2-3-37-12-122.ap-northeast-2.compute.amazonaws.com/api/data/log"
    data = request.request_url(url)

    #파일명 생성 및 json 저장
    import ETL_Pipeline.modules.transform as tf
    import ETL_Pipeline.modules.json_ as json_
...
#데이터 복호화
def decrypt(data):
    import ETL_Pipeline.modules.cryptography_ as crypto
    import ETL_Pipeline.modules.b64uuid_ as b64
    import ETL_Pipeline.modules.transform as transform_
...
def transform(**context):
    ...
    import ETL_Pipeline.modules.transform as transform_
    import ETL_Pipeline.modules.cryptography_ as crypto
    import ETL_Pipeline.modules.gzip_ as gzip_
    import ETL_Pipeline.modules.json_ as json_
    #------------------------------------
...
def load(**context):
    ...
    import ETL_Pipeline.modules.aws_ as aws
